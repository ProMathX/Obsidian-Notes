...
* [IntConst](Studium/EP2/probetests/Vorbereitungstest_C/src/IntConst.java)
* [ConstConstTreeMap](Studium/EP2/probetests/Vorbereitungstest_C/src/ConstConstTreeMap.java)
* [IntConstQueue](Studium/EP2/probetests/Vorbereitungstest_C/src/IntConstQueue.java)
* [Polynomial](Studium/EP2/probetests/Vorbereitungstest_C/src/Polynomial.java)
* [ApplicationTest1](Studium/EP2/probetests/Vorbereitungstest_C/src/ApplicationTest1.java)
* [MCTest1](Studium/EP2/probetests/Vorbereitungstest_C/src/MCTest1.java)
...
Datei [MCTest1](Studium/EP2/probetests/Vorbereitungstest_C/src/MCTest1.java) und befolgen Sie die Anweisungen aus den Kommentaren in der
Datei. Wenn Sie [MCTest1](Studium/EP2/probetests/Vorbereitungstest_C/src/MCTest1.java) ausführen, bekommen Sie eine Fehlermeldung falls
...
binärer Suchbaum wird durch die Klasse [ConstConstTreeMap](Studium/EP2/probetests/Vorbereitungstest_C/src/ConstConstTreeMap.java)
...
`isEqual` und `lessThan` der Klasse [IntConst](Studium/EP2/probetests/Vorbereitungstest_C/src/IntConst.java) bestimmt. Vervollständingen
Sie neben [ConstConstTreeMap](Studium/EP2/probetests/Vorbereitungstest_C/src/ConstConstTreeMap.java) auch die Klasse
[Polynomial](Studium/EP2/probetests/Vorbereitungstest_C/src/Polynomial.java).
Alle anderen gegebenen Dateien sind bereits vollständig. Die Klassen [IntConst](Studium/EP2/probetests/Vorbereitungstest_C/src/IntConst.java)
und [IntConstQueue](Studium/EP2/probetests/Vorbereitungstest_C/src/IntConstQueue.java) dürfen nicht verändert werden.
...
[ConstConstTreeMap](Studium/EP2/probetests/Vorbereitungstest_C/src/ConstConstTreeMap.java). Complete this class. For this purpose, also
...
the methods `isEqual` and `lessThan` of the class [IntConst](Studium/EP2/probetests/Vorbereitungstest_C/src/IntConst.java). Also complete
the class [Polynomial](Studium/EP2/probetests/Vorbereitungstest_C/src/Polynomial.java).
All other provided files are already complete. The classes [IntConst](Studium/EP2/probetests/Vorbereitungstest_C/src/IntConst.java)
and [IntConstQueue](Studium/EP2/probetests/Vorbereitungstest_C/src/IntConstQueue.java) must not be modified.]

Die Klasse [ApplicationTest1](Studium/EP2/probetests/Vorbereitungstest_C/src/ApplicationTest1.java) enthält Testfälle mit Sollausgaben als
Kommentare. Neben diesen Testfällen müssen auch alle Kommentare in den gefragten Klassen
zutreffen. Die Klasse [ApplicationTest1](Studium/EP2/probetests/Vorbereitungstest_C/src/ApplicationTest1.java) fließt nicht in die
