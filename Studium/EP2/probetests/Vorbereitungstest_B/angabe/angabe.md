...
* [Camel](Studium/EP2/probetests/Vorbereitungstest_B/src/Camel.java)
* [Caravan](Studium/EP2/probetests/Vorbereitungstest_B/src/Caravan.java)
* [ApplicationTest1](Studium/EP2/probetests/Vorbereitungstest_B/src/ApplicationTest1.java)
* [MCTest1](Studium/EP2/probetests/Vorbereitungstest_B/src/MCTest1.java)
...
Datei [MCTest1](Studium/EP2/probetests/Vorbereitungstest_B/src/MCTest1.java) und befolgen Sie die Anweisungen aus den Kommentaren in der
Datei. Wenn Sie [MCTest1](Studium/EP2/probetests/Vorbereitungstest_B/src/MCTest1.java) ausführen, bekommen Sie eine Fehlermeldung falls
...
Diese Liste soll durch die Klasse [Caravan](Studium/EP2/probetests/Vorbereitungstest_B/src/Caravan.java) repräsentiert werden. Erstellen
...
stored as elements. This list should be represented by the class [Caravan](Studium/EP2/probetests/Vorbereitungstest_B/src/Caravan.java).
For this purpose, also create your own node class and choose an appropriate name for this class.]

Vervollständigen Sie die dazu gefragte Klasse [Caravan](Studium/EP2/probetests/Vorbereitungstest_B/src/Caravan.java) bitte
wie in den Kommentaren beschrieben an den mit TODO gekennzeichneten Stellen.
Alle anderen gegebenen Dateien sind bereits vollständig. Die Datei [Camel](Studium/EP2/probetests/Vorbereitungstest_B/src/Camel.java)
soll nicht verändert werden.

Die Klasse [ApplicationTest1](Studium/EP2/probetests/Vorbereitungstest_B/src/ApplicationTest1.java) enthält Testfälle mit Sollausgaben als
Kommentare. Neben diesen Testfällen müssen auch alle Kommentare in den gefragten Klassen
zutreffen. Die Klasse [ApplicationTest1](Studium/EP2/probetests/Vorbereitungstest_B/src/ApplicationTest1.java) fließt nicht in die
