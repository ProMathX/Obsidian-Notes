...
* [Rational](Studium/EP2/probetests/Vorbereitungstest_A/src/Rational.java)
* [TreeSetRational](Studium/EP2/probetests/Vorbereitungstest_A/src/TreeSetRational.java)
* [ApplicationTest1](Studium/EP2/probetests/Vorbereitungstest_A/src/ApplicationTest1.java)
* [MCTest1](Studium/EP2/probetests/Vorbereitungstest_A/src/MCTest1.java)
...
Datei [MCTest1](Studium/EP2/probetests/Vorbereitungstest_A/src/MCTest1.java) und befolgen Sie die Anweisungen aus den Kommentaren in der
Datei. Wenn Sie [MCTest1](Studium/EP2/probetests/Vorbereitungstest_A/src/MCTest1.java) ausführen, bekommen Sie eine Fehlermeldung falls
...
Klasse [TreeSetRational](Studium/EP2/probetests/Vorbereitungstest_A/src/TreeSetRational.java)
...
class [TreeSetRational](Studium/EP2/probetests/Vorbereitungstest_A/src/TreeSetRational.java). For this purpose, also create your own node class
...
Vervollständigen Sie dazu die Klasse [TreeSetRational](Studium/EP2/probetests/Vorbereitungstest_A/src/TreeSetRational.java) bitte
wie in den Kommentaren beschrieben an den mit TODO gekennzeichneten Stellen.
Alle anderen gegebenen Dateien sind bereits vollständig. Die Datei [Rational](Studium/EP2/probetests/Vorbereitungstest_A/src/Rational.java)
soll nicht verändert werden.

Die Klasse [ApplicationTest1](Studium/EP2/probetests/Vorbereitungstest_A/src/ApplicationTest1.java) enthält Testfälle mit Sollausgaben als
Kommentare. Neben diesen Testfällen müssen auch alle Kommentare in den gefragten Klassen
zutreffen. Die Klasse [ApplicationTest1](Studium/EP2/probetests/Vorbereitungstest_A/src/ApplicationTest1.java) fließt nicht in die
